...
module.exports = function( grunt ) {
	...
	grunt.initConfig({
		...
		makepot: {
			target: {
				options: {
					...
					potFilename: 'user-theme-options.pot',
					processPot: function( pot ) {
						...
						pot.headers['report-msgid-bugs-to'] = 'https://github.com/enrico-sorcinelli/user-theme-options/issues\n';
						pot.headers['plural-forms'] = 'nplurals=2; plural=n != 1;';
						pot.headers['last-translator'] = 'Enrico Sorcinelli\n';
						pot.headers['language-team'] = 'Enrico Sorcinelli\n';
		...
		checktextdomain: {
			options: {
				text_domain: 'user-theme-options', // eslint-disable-line camelcase
				keywords: [
					'__:1,2d',
					'_e:1,2d',
					'_x:1,2c,3d',
		...
		checkwpversion: {
			...
			pluginVsInternal: { //Check plugin header version against internal defined version.
				version1: 'plugin',
				version2: grunt.file.read( 'user-theme-options.php' ).match( /VERSION', '(.*)'/ )[1],
				compare: '=='
			},
			pluginVsCHANGES: {
				version1: 'plugin',
